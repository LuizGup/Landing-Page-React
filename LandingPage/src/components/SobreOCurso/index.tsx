    ...
    <section className=" " id="sec1">
      <div className="container d-flex pt-5 pb-5">
        <div className="row">
          ...
          <div className="col">
            <div
              className="position-relative text-center mt-3"
              id="containerImgs"
            >
              <img
                src="src/imgs/logonew5.png"
                alt=""
                className="img-fluid imgLogoIndex"
              />
              <img
                src="src/imgs/LogoCodeCrafter2.png"
                alt=""
            ...
            <div className="container pt-5">
              <div className="row justify-content-around">
                <div className="col-md-auto text-center border border-2 border-info rounded p-5 bordersec1">
                  <img
                    src="src/imgs/icons8-html-5-48.png"
                    alt="#"
                ...
                <div className="col-md-auto text-center border border-2 border-info rounded p-5 bordersec1">
                  <img
                    src="src/imgs/icons8-css3-48.png"
                    alt="#"
                    className="imgsec1 mb-1"
                  />
                  <p>
                ...
                <div className="col-md-auto text-center border border-2 border-info rounded p-5 bordersec1">
                  <img
                    src="src/imgs/icons8-javascript-48.png"
                    alt="#"
                    className="imgsec1"
                  />
                  <p>
